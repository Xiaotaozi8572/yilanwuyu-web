<template>
  <main class="explode-page">
    ...
    <ExplodeModelViewer
      :exploded-model-url="assetPath('models/c919-exploded.glb')"
      :assembled-model-url="assetPath('models/c919-assembled.glb')"
      :exploded="isExploded"
      @ready="modelReady = true"
    />

    <button class="back-btn" type="button" aria-label="返回主交互页面" @click="$router.push('/interaction')"></button>
...
<script setup>
import { ref } from 'vue'
import ExplodeModelViewer from '../components/ExplodeModelViewer.vue'
