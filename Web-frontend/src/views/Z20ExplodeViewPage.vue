<template>
  <main class="explode-page">
    ...
    <Z20ExplodeModelViewer
      :exploded-model-url="z20AssetPath('models/直20-爆炸图.glb')"
      :assembled-model-url="z20AssetPath('models/直20-整机.glb')"
      :exploded="isExploded"
      @ready="modelReady = true"
    />

    <button class="back-btn" type="button" aria-label="返回主交互页面" @click="$router.push('/z20/interaction')"></button>
...
<script setup>
import { ref } from 'vue'
import Z20ExplodeModelViewer from '../components/Z20ExplodeModelViewer.vue'
