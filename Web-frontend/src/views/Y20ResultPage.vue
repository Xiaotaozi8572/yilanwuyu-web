<template>
  <SceneShell asset-base="/y20-assets/" :image="sceneImage" alt="知识巩固测试结果">
    <button class="scene-hotspot back-hotspot" @click="$router.push('/y20/interaction')">
      <span class="sr-only">返回主交互页</span>
    </button>
    <button class="scene-hotspot retry-hotspot" @click="$router.push('/y20/quiz')">
      <span class="sr-only">重新挑战</span>
    </button>
    <button class="scene-hotspot home-hotspot" @click="$router.push('/y20/interaction')">
