<template>
  <SceneShell :image="sceneImage" alt="知识巩固测试结果">
    ...
    <button class="scene-hotspot retry-hotspot" @click="$router.push('/quiz')">
      <span class="sr-only">重新挑战</span>
    </button>
    <button class="scene-hotspot home-hotspot" @click="$router.push('/interaction')">
...
const sceneImage = computed(() => `9结果页/${score.value}.jpg`)
</script>
