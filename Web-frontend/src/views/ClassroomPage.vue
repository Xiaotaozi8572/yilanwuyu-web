    ...
    <div class="classroom-frame">
      ...
      <section class="classroom-layout">
        ...
        <section class="lesson-center" aria-label="当前课程">
          <a class="video-card" :href="assetPath(currentLessonData.video)" @click.prevent="openLessonVideo">
            <span class="video-card-visual" :class="{ 'preview-ready': previewReady }">
              <img
                class="video-placeholder"
                :src="assetPath(currentLessonData.cover)"
              ...
              <video
                ...
                class="video-preview"
                :src="assetPath(currentLessonData.video)"
                muted
                preload="metadata"
                playsinline
                webkit-playsinline
          ...
          <div class="lesson-meta">
            ...
            <p>时长 {{ currentLessonData.duration }} · 讲师 小翼</p>
          </div>
          <div class="lesson-progress" :style="progressStyle" aria-hidden="true"></div>
        </section>

        <aside class="news-panel" aria-label="图片和视频资讯">
          <img class="panel-title" :src="assetPath('小讲堂页/点击图片观看新闻资讯.png')" alt="点击图片观看新闻资讯" />
      ...
      <transition name="modal">
        ...
        >
          ...
          <video
            ...
            class="modal-video"
            :src="assetPath(activeModal.src)"
            :poster="assetPath(activeModal.poster)"
            controls
            autoplay
            playsinline
            webkit-playsinline
          ...
          <div v-else-if="activeModal.kind === 'story'" class="story-view">
            <figure class="story-photo">
              <img :src="assetPath(activeModal.image)" :alt="activeModal.title" />
            </figure>
            <video
              class="story-video"
              :src="assetPath(activeModal.src)"
          ...
          <img v-else class="modal-image" :src="assetPath(activeModal.src)" :alt="activeModal.title" />
...
const lessons = [
  {
    section: '第一节',
    topic: 'C919 是一架怎样的飞机',
    title: '第一节 C919 是一架怎样的飞机',
    duration: '01:25',
    cover: '7虚拟课堂页/默认.jpg',
    titleImage: '小讲堂页/第一节标题.png',
    video: '虚拟课堂课程视频/第一节.mp4'
  },
  {
    section: '第二节',
    topic: 'C919 的核心技术有哪些',
    title: '第二节 C919 的核心技术有哪些',
    duration: '01:23',
    cover: '7虚拟课堂页/第二节.jpg',
    titleImage: '小讲堂页/第二节标题.png',
    video: '虚拟课堂课程视频/第二节.mp4'
  },
  {
    section: '第三节',
    topic: 'C919 的研制历程',
    title: '第三节 C919 的研制历程',
    duration: '01:33',
    cover: '7虚拟课堂页/第三节.jpg',
    titleImage: '小讲堂页/第三节标题.png',
    video: '虚拟课堂课程视频/第三节.mp4'
  }
]
...
const mediaItems = [
  {
    title: '驾驶舱介绍',
    image: '小讲堂页/照片01.png',
    video: '虚拟课堂-照片集视频/驾驶舱介绍.mp4',
    description: '进入 C919 驾驶舱，了解座舱布局与关键操纵界面。'
  },
  {
    title: '记者采访驾驶舱',
    image: '小讲堂页/照片02.png',
    video: '虚拟课堂-照片集视频/记者采访驾驶舱.mp4',
    description: '通过采访视角观察 C919 驾驶舱设计。'
  },
  {
    title: '程不时谈 C919',
    image: '小讲堂页/照片03.png',
    video: '虚拟课堂-照片集视频/程不时.mp4',
    description: '航空专家讲述国产大飞机的研发意义。'
  },
  {
    title: 'C919 团队',
    image: '小讲堂页/照片04.png',
    video: '虚拟课堂-照片集视频/习近平会见c919团队.mp4',
    description: '了解 C919 团队与国产大飞机的重要时刻。'
  },
  {
    title: 'C919 部件',
    image: '小讲堂页/照片05.png',
    video: '虚拟课堂-照片集视频/c919部件.mp4',
    description: '从部件角度认识 C919 的结构组成。'
  },
  {
    title: '商业首飞',
    image: '小讲堂页/照片06.png',
    video: '虚拟课堂-照片集视频/c919商业首飞.mp4',
    description: '回顾 C919 商业首飞的历史节点。'
  }
]

const infoCard = {
  title: 'C919 核心参数',
  description: 'C919 基本参数与核心信息总览。'
}

const infoSpecs = [
  { label: '最大起飞重量', value: '75,100', unit: 'kg' },
  { label: '最大着陆重量', value: '67,800', unit: 'kg' },
  { label: '起飞场长', value: '2,000', unit: 'm' },
  { label: '着陆场长', value: '1,800', unit: 'm' },
  { label: '满座航程', value: '2,200', unit: 'n mile' },
  { label: '座位布局', value: '158 - 192', unit: '座' }
]
...
function openLessonVideo() {
  activeModal.value = {
    ...
    description: `时长 ${currentLessonData.value.duration}，讲师 小翼`,
