<template>
  <main class="explode-page">
    ...
    <Y20ExplodeModelViewer
      :exploded-model-url="y20AssetPath('models/运20爆炸图.glb')"
      :assembled-model-url="y20AssetPath('models/运20本体.glb')"
      :exploded="isExploded"
      @ready="modelReady = true"
    />

    <button class="back-btn" type="button" aria-label="返回主交互页面" @click="$router.push('/y20/interaction')"></button>
...
<script setup>
import { ref } from 'vue'
import Y20ExplodeModelViewer from '../components/Y20ExplodeModelViewer.vue'
