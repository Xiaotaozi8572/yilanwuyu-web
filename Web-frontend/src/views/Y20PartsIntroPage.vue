<template>
  <main class="parts-page" :class="`part-${activePart}`">
    <button class="back-btn" type="button" aria-label="返回主交互页" @click="$router.push('/y20/interaction')"></button>
    ...
    <section class="bottom-board">
      ...
      <button class="board-return" type="button" aria-label="返回主交互页" @click="$router.push('/y20/interaction')"></button>
    </section>
...
const p = (part, file) => y20AssetPath(`运20UI分层/部件介绍页/${part}/${file}`)
...
const parts = [
  {
    ...
    label: '机头',
    title: '圆润无下巴机头',
    titleImage: p('机头', '__ 圆润无_下巴_机头 __.png'),
    mainImage: p('机头', '标注合成主图.png'),
    basicCardImage: p('机头', '信息介绍卡片.png'),
    featureCardImage: p('机头', '图文介绍卡片.png'),
    bottomCardImage: p('机头', '玻璃下卡片.png'),
    rightCardImage: p('机头', '右侧卡片.png'),
    teacherCardImage: p('机头', '机器人.png'),
    rings: []
  },
  {
    id: 'engine',
    label: '发动机',
    title: 'WS-20 涡扇发动机',
    titleImage: p('发动机', '__ WS-20涡扇发动机 __.png'),
    mainImage: p('发动机', '发动机.png'),
    basicCardImage: p('发动机', '信息介绍卡片.png'),
    featureCardImage: p('发动机', '图文介绍卡片.png'),
  ...
  },
  {
    ...
    label: '超临界机翼',
    title: '超临界机翼',
    titleImage: p('超临界机翼', '__ 超临界机翼 __.png'),
    mainImage: p('超临界机翼', '标注合成主图.png'),
    basicCardImage: p('超临界机翼', '信息介绍卡片.png'),
    featureCardImage: p('超临界机翼', '图文介绍卡片.png'),
    bottomCardImage: p('超临界机翼', '玻璃下卡片.png'),
    rightCardImage: p('超临界机翼', '右侧卡片.png'),
    teacherCardImage: p('超临界机翼', '机器人.png'),
    rings: []
  },
  {
    id: 'box',
    label: '中央翼盒',
    title: '外置中央翼盒',
    titleImage: p('中央翼盒', '__ _驼背_外置中央翼盒 __.png'),
    mainImage: p('中央翼盒', '标注合成主图.png'),
    basicCardImage: p('中央翼盒', '信息介绍卡片.png'),
    featureCardImage: p('中央翼盒', '图文介绍卡片.png'),
    bottomCardImage: p('中央翼盒', '玻璃下卡片.png'),
    rightCardImage: p('中央翼盒', '右侧卡片.png'),
    teacherCardImage: p('中央翼盒', '机器人.png'),
    rings: []
  },
  {
    id: 'tail',
    label: 'T型高平尾',
    title: 'T型高平尾',
    titleImage: p('T型高平尾', '__ T型高平尾 __.png'),
    mainImage: p('T型高平尾', '标注合成主图.png'),
    basicCardImage: p('T型高平尾', '信息介绍卡片.png'),
    featureCardImage: p('T型高平尾', '图文介绍卡片.png'),
    bottomCardImage: p('T型高平尾', '玻璃下卡片.png'),
    rightCardImage: p('T型高平尾', '右侧卡片.png'),
    teacherCardImage: p('T型高平尾', '机器人.png'),
    rings: []
  }
]
...
function selectPart(id) {
  activePart.value = id
  router.replace({ path: '/y20/parts', query: { part: id } })
}

function goModel() {
  router.push({ path: '/y20/parts-3d', query: { part: activePart.value } })
}
