...
const partHotspots = [
  { id: 'glass', label: '两块式风挡', style: { '--x': 11.1, '--y': 40.3, '--w': 10.9, '--h': 4.4 } },
  { id: 'rotor', label: '五叶主旋翼', style: { '--x': 27.9, '--y': 27.4, '--w': 9.8, '--h': 4.4 } },
  { id: 'engine', label: 'WZ-10涡轴发动机', style: { '--x': 49.0, '--y': 47.0, '--w': 7.5, '--h': 4.4 } },
  { id: 'gear', label: '起落架', style: { '--x': 47.6, '--y': 61.3, '--w': 7.6, '--h': 4.5 } },
  { id: 'tail', label: '剪刀式尾桨', style: { '--x': 68.5, '--y': 24.9, '--w': 9.8, '--h': 4.4 } }
]

const menuHotspots = [
  { label: '爆炸拆解', route: '/z20/explode', style: { '--x': 83.819, '--y': 43.697, '--w': 7.361, '--h': 11.592 } },
  { label: '模拟驾驶', route: '/z20/cockpit', style: { '--x': 83.819, '--y': 55.288, '--w': 7.361, '--h': 11.592 } },
  { label: '虚拟课堂', route: '/z20/classroom', style: { '--x': 83.819, '--y': 66.88, '--w': 7.361, '--h': 11.592 } },
  { label: '知识巩固', route: '/z20/quiz', style: { '--x': 83.819, '--y': 78.472, '--w': 7.361, '--h': 11.592 } }
]
...
const timelineFrames = [
  '直20UI分层/时间轴/Frame 37.png',
  '直20UI分层/时间轴/Frame 38.png',
  '直20UI分层/时间轴/Frame 39.png',
  '直20UI分层/时间轴/Frame 40.png',
  '直20UI分层/时间轴/Frame 41.png',
  '直20UI分层/时间轴/Frame 42.png'
]

const timelineMilestones = [9.558, 25.828, 42.099, 58.37, 74.64, 90.911]
...
function openPart(part) {
  router.push({ path: '/z20/parts', query: { part } })
}
</script>
