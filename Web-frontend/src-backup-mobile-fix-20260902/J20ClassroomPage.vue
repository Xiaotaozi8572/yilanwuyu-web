      ...
      <section class="classroom-layout">
        <aside class="lesson-rail" aria-label="课程视频列表">
          <a
            ...
            :href="j20AssetPath(lesson.video)"
        ...
        <section class="lesson-center" aria-label="当前课程">
          <a class="video-card" :href="j20AssetPath(currentLessonData.video)" @click.prevent="openLessonVideo">
            <span class="video-card-visual" :class="{ 'preview-ready': previewReady }">
              <img
                class="video-placeholder"
                :src="j20AssetPath(currentLessonData.cover)"
              ...
              <video
                ...
                class="video-preview"
                :src="j20AssetPath(currentLessonData.video)"
                muted
                preload="metadata"
                playsinline
          ...
          <div class="lesson-meta">
            ...
            <p>时长 {{ currentLessonData.duration }} · 讲师 威龙</p>
          </div>
          <div class="lesson-progress" :style="progressStyle" aria-hidden="true"></div>
        </section>

        <aside class="news-panel" aria-label="图片和视频资讯">
          <img class="panel-title" :src="j20AssetPath('歼20UI分层/虚拟课堂页/点击卡片观看歼20相关资讯.png')" alt="点击卡片观看歼20相关资讯" />
          ...
          <div class="photo-stack">
            <a
              ...
              :key="item.title"
              class="photo-link"
              :href="j20AssetPath(item.video)"
              @click.prevent="openMedia(item)"
            >
              <img :src="j20AssetPath(item.image)" :alt="item.title" />
      ...
      <transition name="modal">
        ...
        >
          ...
          <video
            ...
            class="modal-video"
            :src="j20AssetPath(activeModal.src)"
            :poster="j20AssetPath(activeModal.poster)"
            controls
            autoplay
            playsinline
          ></video>
          ...
          <div v-else-if="activeModal.kind === 'story'" class="story-view">
            <figure class="story-photo">
              <img :src="j20AssetPath(activeModal.image)" :alt="activeModal.title" />
            </figure>
            <video
              class="story-video"
              :src="j20AssetPath(activeModal.src)"
          ...
          <img v-else class="modal-image" :src="j20AssetPath(activeModal.src)" :alt="activeModal.title" />
...
const lessons = [
  {
    section: '第一节',
    topic: '认识歼-20（入门篇）',
    title: '第一节 认识歼-20（入门篇）',
    duration: '01:39',
    cover: '歼20课程视频/歼20-1.png',
    titleImage: '歼20UI分层/虚拟课堂页/第一节标题.png',
    video: '歼20课程视频/歼20-1.mp4'
  },
  {
    section: '第二节',
    topic: '歼-20的技术密码（进阶篇）',
    title: '第二节 歼-20的技术密码（进阶篇）',
    duration: '02:01',
    cover: '歼20课程视频/歼20-2.png',
    titleImage: '歼20UI分层/虚拟课堂页/第二节标题.png',
    video: '歼20课程视频/歼20-2.mp4'
  },
  {
    section: '第三节',
    topic: '歼-20的作战体系（专业篇）',
    title: '第三节 歼-20的作战体系（专业篇）',
    duration: '02:01',
    cover: '歼20课程视频/歼20-3.png',
    titleImage: '歼20UI分层/虚拟课堂页/第三节标题.png',
    video: '歼20课程视频/歼20-3.mp4'
  }
]
...
const mediaItems = [
  {
    title: '歼20首飞',
    image: '歼20UI分层/虚拟课堂页/照片01.png',
    video: '歼20新闻视频/歼20首飞.mp4',
    description: '回顾歼-20 首飞的历史性时刻。'
  },
  {
    title: '从初教-6到歼-20飞1000小时只是入门',
    image: '歼20UI分层/虚拟课堂页/照片02.png',
    video: '歼20新闻视频/从初教-6到歼-20飞1000小时只是入门.mp4',
    description: '飞行员眼中的歼-20 飞行生涯。'
  },
  {
    title: '歼20英姿',
    image: '歼20UI分层/虚拟课堂页/照片03.png',
    video: '歼20新闻视频/歼20英姿.mp4',
    description: '歼-20 翱翔天空的英姿实录。'
  },
  {
    title: '多架歼20霸气逼退外机',
    image: '歼20UI分层/虚拟课堂页/照片04.png',
    video: '歼20新闻视频/多架歼20霸气逼退外机.mp4',
    description: '歼-20 编队驱离外机的霸气瞬间。'
  },
  {
    title: '歼20歼16歼10C大机群体系对抗',
    image: '歼20UI分层/虚拟课堂页/照片05.png',
    video: '歼20新闻视频/歼20歼16歼10C大机群体系对抗.mp4',
    description: '歼-20 领衔的大机群体系对抗演练。'
  },
  {
    title: '歼20飞行员回忆护航志愿军烈士回家',
    image: '歼20UI分层/虚拟课堂页/照片06.png',
    video: '歼20新闻视频/歼20飞行员回忆护航志愿军烈士回家哭了.mp4',
    description: '歼-20 护航志愿军烈士遗骸回家的感人故事。'
  }
]

const infoSpecs = [
  { label: '最大起飞重量', value: '37', unit: '吨' },
  { label: '最大速度', value: '2.0', unit: 'Ma' },
  { label: '最大航程', value: '5500', unit: 'km' },
  { label: '机长', value: '21', unit: 'm' },
  { label: '发动机', value: '涡扇-15 ×2' },
  { label: '首飞年份', value: '2011', unit: '年' }
]
...
function openLessonVideo() {
  activeModal.value = {
    ...
    description: `时长 ${currentLessonData.value.duration}，讲师 威龙`,
