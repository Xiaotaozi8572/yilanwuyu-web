      ...
      <section class="classroom-layout">
        <aside class="lesson-rail" aria-label="课程视频列表">
          <a
            ...
            :href="y20AssetPath(lesson.video)"
        ...
        <section class="lesson-center" aria-label="当前课程">
          <a class="video-card" :href="y20AssetPath(currentLessonData.video)" @click.prevent="openLessonVideo">
            <span class="video-card-visual" :class="{ 'preview-ready': previewReady }">
              <img
                class="video-placeholder"
                :src="y20AssetPath(currentLessonData.cover)"
              ...
              <video
                ...
                class="video-preview"
                :src="y20AssetPath(currentLessonData.video)"
                muted
                preload="metadata"
                playsinline
          ...
          <div class="lesson-meta">
            ...
            <p>时长 {{ currentLessonData.duration }} · 讲师 鲲鹏</p>
          </div>
          <div class="lesson-progress" :style="progressStyle" aria-hidden="true"></div>
        </section>

        <aside class="news-panel" aria-label="图片和视频资讯">
          <img class="panel-title" :src="y20AssetPath('运20UI分层/虚拟课堂页/点击卡片观看运20相关资讯.png')" alt="点击卡片观看运20相关资讯" />
          ...
          <div class="photo-stack">
            <a
              ...
              :key="item.title"
              class="photo-link"
              :href="y20AssetPath(item.video)"
              @click.prevent="openMedia(item)"
            >
              <img :src="y20AssetPath(item.image)" :alt="item.title" />
      ...
      <transition name="modal">
        ...
        >
          ...
          <video
            ...
            class="modal-video"
            :src="y20AssetPath(activeModal.src)"
            :poster="y20AssetPath(activeModal.poster)"
            controls
            autoplay
            playsinline
          ></video>
          ...
          <div v-else-if="activeModal.kind === 'story'" class="story-view">
            <figure class="story-photo">
              <img :src="y20AssetPath(activeModal.image)" :alt="activeModal.title" />
            </figure>
            <video
              class="story-video"
              :src="y20AssetPath(activeModal.src)"
          ...
          <img v-else class="modal-image" :src="y20AssetPath(activeModal.src)" :alt="activeModal.title" />
...
const lessons = [
  {
    section: '第一节',
    topic: '认识运-20（入门篇）',
    title: '第一节 认识运-20（入门篇）',
    duration: '01:32',
    cover: '运20课程视频/运20-1.png',
    titleImage: '运20UI分层/虚拟课堂页/第一节标题.png',
    video: '运20课程视频/运20-1.mp4'
  },
  {
    section: '第二节',
    topic: '运-20的技术密码（进阶篇）',
    title: '第二节 运-20的技术密码（进阶篇）',
    duration: '01:44',
    cover: '运20课程视频/运20-2.png',
    titleImage: '运20UI分层/虚拟课堂页/第二节标题.png',
    video: '运20课程视频/运20-2.mp4'
  },
  {
    section: '第三节',
    topic: '运-20的任务与家族（应用篇）',
    title: '第三节 运-20的任务与家族（应用篇）',
    duration: '01:44',
    cover: '运20课程视频/运20-3.png',
    titleImage: '运20UI分层/虚拟课堂页/第三节标题.png',
    video: '运20课程视频/运20-3.mp4'
  }
]
...
const mediaItems = [
  {
    title: '运-20 国风大片',
    image: '运20UI分层/虚拟课堂页/照片01.png',
    video: '运20新闻视频/运-20国风大片.mp4',
    description: '以国风视角记录运-20 的磅礴气势。'
  },
  {
    title: '运20总师说我们想争一口气',
    image: '运20UI分层/虚拟课堂页/照片02.png',
    video: '运20新闻视频/运20总师说我们想争一口气.mp4',
    description: '总设计师谈运-20 研制背后的民族情怀。'
  },
  {
    title: '运20 有一位女设计师',
    image: '运20UI分层/虚拟课堂页/照片03.png',
    video: '运20新闻视频/运20有一位女设计师.mp4',
    description: '讲述运-20 研制团队中的女设计师故事。'
  },
  {
    title: '运-20 生产车间罕见曝光',
    image: '运20UI分层/虚拟课堂页/照片04.png',
    video: '运20新闻视频/运-20生产车间罕见曝光.mp4',
    description: '近距离见证运-20 的生产制造现场。'
  },
  {
    title: '运20列装10年名场面不断',
    image: '运20UI分层/虚拟课堂页/照片05.png',
    video: '运20新闻视频/运20列装10年名场面不断.mp4',
    description: '回顾运-20 列装十年来的高光时刻。'
  },
  {
    title: '鲲鹏运20成功首飞10周年',
    image: '运20UI分层/虚拟课堂页/照片06.png',
    video: '运20新闻视频/鲲鹏运20成功首飞10周年.mp4',
    description: '纪念运-20 首飞十周年，回顾鲲鹏征程。'
  }
]

const infoSpecs = [
  { label: '最大起飞重量', value: '200', unit: '吨级' },
  { label: '最大载重', value: '66', unit: '吨' },
  { label: '最大航程', value: '7800', unit: 'km' },
  { label: '机长', value: '47', unit: 'm' },
  { label: '发动机', value: '涡扇-20 ×4' },
  { label: '实用升限', value: '13,000', unit: 'm' }
]
...
function openLessonVideo() {
  activeModal.value = {
    ...
    description: `时长 ${currentLessonData.value.duration}，讲师 鲲鹏`,
